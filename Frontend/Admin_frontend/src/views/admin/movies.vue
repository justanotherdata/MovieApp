<template>
    ...
    <div class="container container_style">
        ...
        <button class="btn btn-dark col-6 btn_style" @click="gotoaddmovie"><h5>Add New Movie</h5></button>
        ...
        <div class="container" v-if="!movies_data">
            <h1>No Movies have been created By this User!</h1>
            <h2>Create a movie by clicking the button above!</h2>
        </div>
    </div>
</template>
...
export default{
    ...
    beforeMount(){
        this.$store.dispatch('get_movies_data')
    }
}
</script>
